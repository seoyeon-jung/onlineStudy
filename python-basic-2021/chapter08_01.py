...
print(all([1,2,3]))   # and(하나라도 false면 false)
print(any([1,2,0]))   # or (하나만 true면 true)
...
print(list(filter(lambda x: abs(x) > 2, [1, -3, 2, 0, -5, 6])))  #함수 없어도 가능(lambda)
...
print(list(zip([10, 20, 30], [40, 50, 60])))  #짝없으면 있는것끼리 반환
